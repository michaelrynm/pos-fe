...
export default function CustomerTableManagementHeader() {
  return (
    <div className="flex items-center justify-between">
      <div>
        <p className="font-semibold text-lg">Table Settings</p>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink>Table Settings</BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
